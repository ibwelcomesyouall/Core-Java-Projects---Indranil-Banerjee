...
public class Main {
    ...
    public static void main(String[] args) throws InvalidFormatException, IOException
	{
			...
			Iterator<Row> rowIterator = sheet.iterator();
                       ...
                       try {
                         BufferedReader in = new BufferedReader(new FileReader("Artifacts\\userdefined2.txt"));
                        String str;
                        ...
                        Set<String> names1 = new HashSet<String>();
                         try {
                         BufferedReader in = new BufferedReader(new FileReader("Artifacts\\prefix.txt"));
                        String str;
                        while ((str = in.readLine()) != null)
                        names1.add(str);
                        in.close();
