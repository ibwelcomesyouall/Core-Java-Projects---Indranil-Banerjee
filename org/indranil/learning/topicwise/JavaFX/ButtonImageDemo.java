...
public class ButtonImageDemo extends Application {
	...
	public void start(Stage myStage) {
		...
		Button btnHourglass = new Button("Hourglass",  new ImageView("Artifacts//Hourglass.png"));
		Button btnAnalogClock = new Button("Analog Clock",  new ImageView("Artifacts//AnalogClock.png"));
